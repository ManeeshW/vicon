...
def main():
    ...
    vicon_tracker.open("Racing@192.168.10.1")  # You can pass a specific object string if needed, e.g., "racing@192.168.10.1"
    ...
    try:
        ...
        while True:
            ...
            H_vm = torch.eye(4)  # Initialize 4x4 identity matrix
            H_vm[:3, :3] = torch.tensor(R_vm)  # Top-left 3x3 block for rotation matrix
            H_vm[:3, 3] = torch.tensor(x_v)  # Top-right 3x1 block for position vector
